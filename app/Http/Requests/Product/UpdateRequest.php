...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'wholesale_cost' => ['required','numeric'],            'discount' => ['nullable', 'numeric', 'min:0'],
            'discount_type' => ['nullable', 'integer', 'in:1,2'],            'in_stock' => ['required','numeric'],
    ...
    public function messages()
    {
        return [
            ...
            'discount.min' => 'Chiết khấu không được âm',
            'discount_type.integer' => 'Loại chiết khấu phải là số nguyên',
            'discount_type.in' => 'Loại chiết khấu không hợp lệ',
